...
<head>
    <title><? echo lang('welcome'); ?> | BeU - Social Network For High School Students </title>
    <meta charset="UTF-8">
    ...
    <!--============[ Nav bar ]============-->
        <div class="login_signup_navbar">
                <a href="index" class="login_signup_navbarLinks">::BeU::</a>
        ...
        <h3 align="center"><? echo lang('welcome_to'); ?> ::BeU::</h3>
        <p align="center" style="color: #999; margin-bottom: 25px;"><? echo lang('beu_main_string'); ?>.</p>
            <div style="display: flex;">
                ...
                <div style="width: 100%;text-align: center;">
                    <img src="imgs/main_icons/pc_main.png" alt="::BeU::" style="width: 300px;" />
                </div>
            </div>
        </div>
        <div style="background: #fff; border-radius: 3px; max-width: 800px; padding: 15px; margin:auto;margin-top: 15px;color: #7b7b7b;" align="center">
            <? echo lang('dont_have_an_account'); ?> <a href="signup"><? echo lang('signup'); ?></a> <? echo lang('for_free'); ?>.<hr style="margin: 8px;">
                <a href="?lang=english">English</a> &bull; <a href="?lang=vietnamese">Ti&#7871;ng Vi&#7879;t</a>
        </div>

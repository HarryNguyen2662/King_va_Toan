...
if (isset($_POST['submit_uInfo'])) {
    ...
    if(strpos($db_username, ' ') !== false || preg_match('/[\'^Â£$%&*()}{@#~?><>,.|=+Â¬-]/', $db_username) || !preg_match('/[A-Za-z0-9]+/', $db_username)) {
        $update_result = "
...
<head>
    ...
    <admin charset="UTF-8">
 <admin name="description" content="BeU là m&#7841;ng xã h&#7897;i thu nh&#7887; dành cho h&#7885;c sinh có cùng s&#7903; thích và tính cách.">

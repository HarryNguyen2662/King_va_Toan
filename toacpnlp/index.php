...
<head>
    <title><? echo lang('dashboard'); ?> | BeU - Social Network For High School Students</title>
    <meta charset="UTF-8">
...
<div class="dashboard_box" style="text-align: <? echo lang('textAlign'); ?>">
    ...
    <div id="General">
        <div id="1row" style="display: flex;">
            <div class="details">
            <span style='<? echo lang('float'); ?>:unset' class="fa fa-users" ?>:unset' class="fa fa-users" ?>:unset' class="fa fa-users" ?>:10%;<? echo lang('float'); ?>:unset;' class="fa fa-users"></span>
               <p><h3><?php echo $users; ?></h3> <? echo lang('users'); ?></p>
            </div>
            <div class="details">
            <span style='<? echo lang('float'); ?>:unset' class="fa fa-male" ?>:unset' class="fa fa-male" ?>:unset' class="fa fa-male" ?>:10%;<? echo lang('float'); ?>:unset;' class="fa fa-male"></span>
               <p><h3><?php echo $genderM; ?></h3> <? echo lang('males'); ?></p>
            </div>
            <div class="details">
            <span style='<? echo lang('float'); ?>:unset' class="fa fa-female" ?>:unset' class="fa fa-female" ?>:unset' class="fa fa-female" ?>:10%;<? echo lang('float'); ?>:unset;' class="fa fa-female"></span>
               <p><h3><?php echo $genderF; ?></h3> <? echo lang('females'); ?></p>
            </div>
        </div>
        <div id="row2" style="display: flex;">
            <div class="details" style="background: #673AB7;">
            <span style='<? echo lang('float'); ?>:unset' class="fa fa-envelope" ?>:unset' class="fa fa-envelope" ?>:unset' class="fa fa-envelope" ?>:10%;<? echo lang('float'); ?>:unset;' class="fa fa-envelope"></span>
               <p><h3><? echo $msgs; ?></h3> <? echo lang('messages'); ?></p>
            </div>
            <div class="details" style="background: #9C27B0;">
            <span style='<? echo lang('float'); ?>:unset' class="fa fa-bell" ?>:unset' class="fa fa-bell" ?>:unset' class="fa fa-bell" ?>:10%;<? echo lang('float'); ?>:unset;' class="fa fa-bell"></span>
               <p><h3><?php echo $notifications; ?></h3> <? echo lang('notifications'); ?></p>
            </div>
            <div class="details" style="background: #FFC107;">
            <span style='<? echo lang('float'); ?>:unset' class="fa fa-check" ?>:unset' class="fa fa-check" ?>:unset' class="fa fa-check" ?>:10%;<? echo lang('float'); ?>:unset;' class="fa fa-check"></span>
        ...
        <div id="3row" style="display: flex;">
            ...
            <span style='<? echo lang('float'); ?>:unset' class="fa fa-pencil" ?>:unset' class="fa fa-pencil" ?>:unset' class="fa fa-pencil" ?>:10%;<? echo lang('float'); ?>:unset;' class="fa fa-pencil"></span>
               <p><h3><?php echo $posts; ?></h3> <? echo lang('posts_str'); ?></p>
            </div>
            <div class="details" style="background: #ff9800;">
            <span style='<? echo lang('float'); ?>:unset' class="fa fa-commenting-o" ?>:unset' class="fa fa-commenting-o" ?>:unset' class="fa fa-commenting-o" ?>:10%;<? echo lang('float'); ?>:unset;' class="fa fa-commenting-o"></span>
               <p><h3><?php echo $comments; ?></h3> <? echo lang('comments'); ?></p>
            </div>
            <div class="details" style="background: #FF5722;">
            <span style='<? echo lang('float'); ?>:unset' class="fa fa-heart-o" ?>:unset' class="fa fa-heart-o" ?>:unset' class="fa fa-heart-o" ?>:10%;<? echo lang('float'); ?>:unset;' class="fa fa-heart-o"></span>
               <p><h3><?php echo $likes; ?></h3> <? echo lang('likes'); ?></p>
            </div>
            <div class="details" style="background: #ff9800;">
            <span style='<? echo lang('float'); ?>:unset' class="fa fa-star-o" ?>:unset' class="fa fa-star-o" ?>:unset' class="fa fa-star-o" ?>:10%;<? echo lang('float'); ?>:unset;' class="fa fa-star-o"></span>
               <p><h3><?php echo $stars; ?></h3> <? echo lang('stars'); ?></p>
            </div>
        </div>
        <div id="row4" style="display: flex;">
            <div class="details" style="background: #63ab66;">
            <span style='<? echo lang('float'); ?>:unset' class="fa fa-bookmark-o" ?>:unset' class="fa fa-bookmark-o" ?>:unset' class="fa fa-bookmark-o" ?>:10%;<? echo lang('float'); ?>:unset;' class="fa fa-bookmark-o"></span>
               <p><h3><?php echo $saved; ?></h3> <? echo lang('saved_posts'); ?></p>
            </div>
            <div class="details" style="background: #63ab66;">
            <span style='<? echo lang('float'); ?>:unset' class="fa fa-lock" ?>:unset' class="fa fa-lock" ?>:unset' class="fa fa-lock" ?>:10%;<? echo lang('float'); ?>:unset;' class="fa fa-lock"></span>
               <p><h3><?php echo $notes; ?></h3> <? echo lang('notes'); ?></p>
            </div>
        </div>
        <div id="row5" style="display: flex;">
            <div class="details" style="background: #2196f3;">
            <span style='<? echo lang('float'); ?>:unset' class="fa fa-check-circle" ?>:unset' class="fa fa-check-circle" ?>:unset' class="fa fa-check-circle" ?>:10%;<? echo lang('float'); ?>:unset;' class="fa fa-check-circle"></span>
               <p><h3><?php echo $verified; ?></h3> <? echo lang('verified_users'); ?></p>
            </div>
            <div class="details" style="background: #2196f3;">
            <span style='<? echo lang('float'); ?>:unset' class="fa fa-user-o" ?>:unset' class="fa fa-user-o" ?>:unset' class="fa fa-user-o" ?>:10%;<? echo lang('float'); ?>:unset;' class="fa fa-user-o"></span>
